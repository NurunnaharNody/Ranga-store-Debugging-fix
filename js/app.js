...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${product.image}></img>
      ...
      <p class="icon-detail"> <span class="icon-color"><i class="fas fa-star"></i>
      <i class="fas fa-star"></i>
      <i class="fas fa-star"></i>
      <i class="fas fa-star"></i>
      <i class="fas fa-star-half-alt"></i></span> ${product.rating.rate}</p>
      ...
      <button id="details-btn" class="btn btn-detail">Details</button></div>
      `;
